...
def immediate_transaction() -> Generator[Session, None, None]:
    ...
    one active lease -- SQLite has no ``FOR UPDATE SKIP LOCKED``.  On
    PostgreSQL the same seam runs an ordinary write transaction; claim safety
    there is the documented student exercise (``FOR UPDATE SKIP LOCKED``).
    """
